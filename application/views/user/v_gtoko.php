            ...
            <div class="awesome-menu ">
              <ul class="project-menu">
                ...
                <li>
                  ...
                  <a href="#" data-filter=".photo">Anting</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img height="800px" width="643px" src="<?= base_url(); ?>./assets/adds/images/toko/<?= $row->foto; ?>" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?= base_url(); ?>./assets/adds/images/<?= $row->foto; ?>">
                      <h4>Koleksi Emas</h4>
            ...
            <div class="footer-content">
              <div class="footer-head">
                ...
                <div class="flicker-img">
                  <a class="venobox" data-gall="myGallery" href="<?= base_url(); ?>./assets/adds/images/<?= $row->foto; ?>"><img src="<?= base_url(); ?>./assets/adds/images/<?= $row->foto; ?>" alt=""></a>
                </div>
                 <?php endforeach; ?>
              </div>
            </div>
